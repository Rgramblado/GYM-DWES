    ...
    <script>
        function onClick(e) {
            ...
            grecaptcha.ready(function() {
                grecaptcha.execute('6Le6zCcaAAAAAETllnaUVHRftqXJtXcaIwsu9pwL', {
                    action: 'submit'
                }).then(function(token) {
...
<body>
    ...
    <div class="py-5 text-center text-white h-100 align-items-center justify-content-center d-flex" id="main">
        <form action="#" method="POST">
            ...
            <div class="form-group row">
                <label for="password2" class="col-4 col-form-label">Repetir contraseña</label>
                <div class="col-8">
                    <div class="input-group">
                        <div class="input-group-addon">
                            <i class="fa fa-key"></i>
                        </div>
                        <input id="password2" name="password2" placeholder="Password" type="text" class="form-control" required="required">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="offset-4 col-8">
                    <button name="submit" type="submit" class="btn btn-primary">Renovar contraseña</button>
                </div>
            </div>
        </form>
    </div>
